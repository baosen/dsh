...
# Window file.
wndf.o: wndf.cpp wndf.hpp
	$(COMPILE) -c $< $(FUSELIBS) -o $@

# Compile shell file system executable.
dshfs: dshfs.cpp fs.o log.o kb.o kbsys.o dsys.o wndcmd.o dpycmd.o wsys.o ssys.o msys.o m.o wnd.o fb.o scr.o pix.o pos.o res.o evm.o ev.o ent.o dir.o file.o kbf.o mf.o wndf.o
